...
\begin{entrada}
A entrada é composta por diferentes casos de teste. A primeira linha de cada caso de teste contém $n$, o número de crianças, e $m$, o número da criança que está procurando as demais, $1 \leq n \leq 1000$ e $1 \leq m \leq n$. As $n-2$ linhas seguintes contém um inteiro cada representando as crianças que já foram encontradas.
