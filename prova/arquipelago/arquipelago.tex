...
\begin{entrada}
A entrada contém vários casos de teste. A descrição de cada caso de teste começa com uma linha contendo dois inteiros $2 \leq n \leq MAXN$ e $2 \leq m \leq MAXM$ separados por um espaço, onde $n$ representa o número de linhas do mapa e $m$ o número de colunas.
