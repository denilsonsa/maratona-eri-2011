...
A qualidade do bar $i$ é dada por $Q_i$ e a distância entre os bares $i$ e $j$ é dada por $D_{i,j}$. Assim, de maneira geral, a probabilidade $P_{i,j}$ de Marcos ir do bar $i$ ao bar $j$ é dada por:
...
Dica (opcional): Não se esqueça que a probabilidade de Marcos estar em num bar é sempre igual a 1.
\end{descricao}
